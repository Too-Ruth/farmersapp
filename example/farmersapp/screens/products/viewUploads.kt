...
import com.example.farmersapp.models.Upload
import com.example.farmersapp.navigate.ROUTE_UPDATE_PRODUCTS
...
fun ViewUploadsScreen(navController:NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        val uploads = productRepository.viewProducts(emptyUploadState, emptyUploadsListState)
...
fun Upload(s: String, s1: String, s2: String, s3: String, s4: String) {
